package net.ninemm.base.word.w2004;


import net.ninemm.base.word.api.interfaces.IBody;
import net.ninemm.base.word.api.interfaces.IElement;
import net.ninemm.base.word.api.interfaces.IFooter;
import net.ninemm.base.word.api.interfaces.IHeader;
